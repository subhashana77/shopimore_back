...
$result = DBUtil::executeQuery(
    $connection,
    "SELECT i.id, i.name, i.weight, i.unit, i.unit_price, i.quantity, i.code, i.thumbnail, c.category FROM item i, category c WHERE c.id = i.category_id ORDER BY i.name ASC"
);
